...
# Install screenfetch
wget -qO /usr/bin/screenfetch "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/screenfetch.sh"
...
wget -qO /etc/issue.net "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/issue.net"
...
wget -qO /etc/dropbear_issue.net "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/dropbear_issue.net"
...
wget -qO /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/stunnel.conf"
service stunnel4 restart

# Install Squid3
apt install -y squid3
wget -qO /etc/squid/squid.conf "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/squid.conf"
...
wget -q "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/openvpn/EasyRSA-3.0.8.tgz"
...
wget -qO /etc/openvpn/server-udp.conf "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/openvpn/server-udp.conf"
wget -qO /etc/openvpn/server-tcp.conf "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/openvpn/server-tcp.conf"
...
mkdir -p /admin/openvpn
wget -qO /admin/openvpn/client-udp.ovpn "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/openvpn/client-udp.ovpn"
wget -qO /admin/openvpn/client-tcp.ovpn "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/openvpn/client-tcp.ovpn"
sed -i "s/xx/$ip/g" /admin/openvpn/client-udp.ovpn
sed -i "s/xx/$ip/g" /admin/openvpn/client-tcp.ovpn
echo -e "\n<ca>" >> /admin/openvpn/client-tcp.ovpn
cat "/etc/openvpn/key/ca.crt" >> /admin/openvpn/client-tcp.ovpn
echo -e "</ca>" >> /admin/openvpn/client-tcp.ovpn
echo -e "\n<ca>" >> /admin/openvpn/client-udp.ovpn
cat "/etc/openvpn/key/ca.crt" >> /admin/openvpn/client-udp.ovpn
echo -e "</ca>" >> /admin/openvpn/client-udp.ovpn
...
wget -qO /usr/local/etc/xray/config.json "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/xray/xray_tls_ws_mix-rprx-direct.json"
wget -qO /etc/nginx/conf.d/${domain}.conf "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/xray/web.conf"
sed -i "s/xxx/${domain}/g" /etc/nginx/conf.d/${domain}.conf
sed -i "s/x.x.x.x/${ip}/g" /etc/nginx/conf.d/${domain}.conf
wget -qO web.tar.gz "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/web.tar.gz"
rm -rf /var/www/html/*
...
/root/.acme.sh/acme.sh --installcert -d "${domain}" --fullchainpath /admin/xray/xray.crt --keypath /admin/xray/xray.key --reloadcmd "systemctl restart xray" --ecc --force
sed -i "7d" /etc/nginx/conf.d/${domain}.conf
sed -i "6s/#//" /etc/nginx/conf.d/${domain}.conf
chown -R nobody.nogroup /admin/xray/xray.crt
chown -R nobody.nogroup /admin/xray/xray.key
touch /admin/xray/xray-clients.txt
...
mkdir /admin/wireguard
touch /admin/wireguard/wireguard-clients.txt

# Install OHP
wget -qO /usr/bin/ohpserver "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/ohpserver"
...
cd
apt install -y cmake
wget -qO badvpn.zip "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/badvpn.zip"
unzip badvpn.zip
cd badvpn-master
mkdir build-badvpn
cd build-badvpn
...
# Configure script
wget -qO /usr/bin/0 "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/menu/0.sh"
wget -qO /usr/bin/ssh-vpn-script "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/menu/ssh-vpn-script.sh"
wget -qO /usr/bin/xray-script "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/menu/xray-script.sh"
wget -qO /usr/bin/wireguard-script "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/menu/wireguard-script.sh"
wget -qO /usr/bin/script-info "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/menu/script-info.sh"
wget -qO /usr/bin/script-1 "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/cron/script-1.sh"
wget -qO /usr/bin/script-2 "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/cron/script-2.sh"
wget -qO /usr/bin/script-3 "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/cron/script-3.sh"
chmod +x /usr/bin/{0,ssh-vpn-script,xray-script,wireguard-script,script-info,script-1,script-2,script-3}

# Configure rc.local
wget -qO /etc/rc.local "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/rc.local"
...
wget -qO /etc/systemd/system/script-3.service "https://raw.githubusercontent.com/Hanxhin/Autoscript/main/FILES/cron/script-3.service"
mkdir /admin/script-3
touch /admin/script-3/{multi-login.log,user-lock.log}
echo 2 > /admin/script-3/limit
systemctl daemon-reload
service script-3 start
systemctl enable script-3.

# Configure block all connections
echo off >> /admin/block-status
